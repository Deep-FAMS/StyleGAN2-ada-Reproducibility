...
#SBATCH --job-name='ADA-gen1_pokemon'
...
conda activate $WORK/malyetama/.conda/envs/ada-env
$WORK/.conda/envs/ada-env/bin/python $WORK/ADA_Project/py_scripts/ADA-gen1_pokemon.py
