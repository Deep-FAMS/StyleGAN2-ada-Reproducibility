...
experiment = Experiment(
    api_key="wFdqPXLkG8n4MWWl5o3PKHlch",
    project_name="gan",
    workspace="alyetama",
)
...
def main():
    ...
    parser.add_argument(
        '--resume-pkl', help='Network pickle to resume training from', default=None)
    parser.add_argument(
        '--resume-kimg', help='Assumed training progress at the beginning. Affects reporting and training schedule.', default=0.0, type=float)
    parser.add_argument(
        '--resume-time', help='Assumed wallclock time at the beginning. Affects reporting.', default=0.0, type=float)
    parser.add_argument('--resume-with-new-nets', help='Construct new networks according to G_args and D_args before resuming training (default: %(default)s)',
                        default=False, metavar='BOOL', type=_str_to_bool)
