...
def main():
    ...
    parser.add_argument('--rows', dest='row_seeds', type=_parse_num_range,
                        help='Random seeds to use for image rows', required=True)
    parser.add_argument('--cols', dest='col_seeds', type=_parse_num_range,
    ...
    parser.add_argument('--trunc', dest='truncation_psi', type=float,
